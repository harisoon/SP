...
Book::Book() {}
Book::Book(const std::string& s1, const std::string& s2, const std::string& s3,
           unsigned short m, size_t n)
    : title_{s1}, author_{s2}, publisher_{s3}, year_{m}, num_of_copies_{n}{} 
