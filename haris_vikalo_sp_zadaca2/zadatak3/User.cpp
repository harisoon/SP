...
User::User() {}
User::User (const std::string& s1,const std::string& s2,int n): name_{s1},last_name_{s2},ID_{n} {}
...
MojVektor<Book>::Iterator& User::borrowedBookGetter() { return borrowedBook_; }
void User::borrowedBookSetter(MojVektor<Book>::Iterator book) { borrowedBook_ = book;} 
